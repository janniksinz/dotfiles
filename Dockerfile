...
# RUN bash -c "$(curl -fsSL https://raw.githubusercontent.com/janniksinz/dotfiles/main/bin/dotfiles)"
RUN git clone --quiet https://github.com/janniksinz/dotfiles.git /home/${USER}/.dotfiles
